MapVis = function(model, parentElement) {
    ...
    this.updateVis = function () {
        ...
        var dotColor = function (d) {
            if (_that.options.category === 'color') {
                ...
                return _that.palette(d.label_num);
                ...
                return _that.palette(19 - _that.dataMap.get(d.properties.NAME)['cluster_outof_' + outof]);
            } else {
                //console.log(d.cat_from_20, _that.palette(d.cat_from_20));
                return _that.palette(d['color_for_' + _that.options.category]);
            }
        };
    //
